...
if (isset ($_POST['ubah']))
{
    ...
    if (!empty($lokasifoto)){
        ...
        $koneksi->query("UPDATE produk SET nama_produk='$_POST[nama]',harga_produk='$_POST[harga]',berat_produk='$_POST[berat]',deskripsi_produk='$_POST
            [deskripsi]',stok_produk='$_POST[stok]',id_kategori=$_POST[id_kategori] WHERE id_produk='$_GET[id]'");
    }
